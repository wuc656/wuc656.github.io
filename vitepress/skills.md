...
- **ORM**：[XORM](https://xorm.io/) v1.3.11 — 物件關聯對應工具
- **應用場景**：
  - 營建工程管理 ERP 系統後端 API
  - RESTful API 設計與開發
  - 資料庫操作與管理
...
- **建構工具**：Vite v7.2.6
- **UI 框架**：
  - [PrimeVue](https://primevue.org/) v4.5.4 — 豐富的 UI 元件庫
  - [TailwindCSS](https://tailwindcss.com/) v4.1.18 — Utility-first CSS 框架
  - [MasterCSS](https://master.co/) v1.37.8 — 語法驅動的 CSS 框架
