...
- 我目前正在將舊有的 Delphi 2009 ERP應用程式逐步重寫為網頁版的 Web 應用，後端用 Golang 的 Echo 和 XORM，前端用 Vue.js、Vite、PrimeVue、TailwindCSS。
...
[燕雲十六聲](https://www.wherewindsmeetgame.com/hmt/index.html "燕雲十六聲")
